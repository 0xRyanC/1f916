  ...
  for (const r of SURFACE) {
    ...
    for (const v of verbs) {
      ...
      paths[path][v.toLowerCase()] = {
        ...
        responses: { ...errorResponses, ...write400, ...forbidden403, ...query400, ...cap429, ...reg429, ...register409, ...patron402, ...screen422, ...typed404, ...plain404, ...conflict409, ...conditional304, ...rot429, [success]: { description: responseDesc, content: { [media]: {} } } },
      };
    }
  }
  return {
